<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <!-- Profile Pic -->
         ...
         <input type="file" name="profile_pic" id="profile_pic" accept="image/*" class="block mt-1 w-full">
            <x-input-error :messages="$errors->get('profile_pic')" class="mt-2" />
         </div>
        <!-- Choose Photographer o client -->
        <div class="mt-4">
            ...
            <option value="Client">I want to buy photos</option>
                <option value="Photographer">I want to sell photos</option>
            </select>
        </div>
        <!-- Password -->
        <div class="mt-4">
